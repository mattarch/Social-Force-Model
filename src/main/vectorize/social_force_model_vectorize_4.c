...
/*
  ...
  Parameters: 
        ...
        people_repulsion_term: (2n,2n) : matrix containing the force of repulsion between person i and j
                            n: number of people
*/
void update_people_repulsion_term_vectorize_4(float *position, float *desired_direction, float *actual_speed, float *people_repulsion_term, int n)
{
  __m256 position_i_x;
  __m256 position_i_y;
                                  ...
                                  float *people_repulsion_term, float *border_repulsion_term, float *social_force, float *desired_speed, float *desired_max_speed)
{
  ...
  {
    // update variables
    update_desired_direction_vectorize_4(position, final_destination, desired_direction, number_of_people);
    update_acceleration_term_vectorize_4(desired_direction, acceleration_term, actual_velocity, desired_speed, number_of_people);
    update_people_repulsion_term_vectorize_4(position, desired_direction, speed, people_repulsion_term, number_of_people);
