...
__m256 exp_fast_vec_2(__m256 x, __m256 one, __m256 exp_constant)
{
...
/*
  ...
  Parameters: 
        ...
        people_repulsion_term: (2n,2n) : matrix containing the force of repulsion between person i and j
                            n: number of people
*/
void update_people_repulsion_term_vectorize_2(float *position, float *desired_direction, float *actual_speed, float *people_repulsion_term, int n)
{
  __m256 position_i_x;
  __m256 position_i_y;
