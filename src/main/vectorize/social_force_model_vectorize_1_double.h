...
#ifndef VECTORIZE_1_DOUBLE_H_ /* Include guard */
#define VECTORIZE_1_DOUBLE_H_
...
void update_people_repulsion_term_vectorize_1_double(double *position, double *desired_direction, double *actual_speed, double *Repulsion_term, int n);
