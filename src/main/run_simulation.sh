...
if [ $os == "Darwin" ]; then
  gcc-9 social_force.c parse_args.c utility.c testing.c social_force_model_basic.c social_force_model_basic_simplified.c vectorize/social_force_model_vectorize_1.c -mavx2 aligned_free.c aligned_malloc.c -mfma -lm -O3  -g -o $prog
else
  gcc social_force.c parse_args.c utility.c testing.c social_force_model_basic.c social_force_model_basic_simplified.c vectorize/social_force_model_vectorize_1.c -mavx2 aligned_free.c aligned_malloc.c -mfma -lm -O3 -g -o $prog
fi
