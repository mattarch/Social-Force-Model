...
if [ $os == "Darwin" ]; then
  gcc-9 social_force.c parse_args.c utility.c testing.c social_force_model_basic.c social_force_model_basic_simplified.c -lm -O3 -ffast-math -g -o $prog
else
  gcc social_force.c parse_args.c utility.c testing.c social_force_model_basic.c social_force_model_basic_simplified.c -lm -O3 -ffast-math -g -o $prog
fi
